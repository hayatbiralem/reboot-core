...
if (!is_admin() && $GLOBALS['pagenow'] != 'wp-login.php') {
    if (!reboot_required_tgmpa_plugins_installed()) {
        die(__('You have to install all required plugins!', REBOOT_CORE_TEXT_DOMAIN));
    }
}
...
function reboot_register_required_plugins()
{
     ...
     */
    $config = array(
        'id' => REBOOT_CORE_TEXT_DOMAIN,                 // Unique ID for hashing notices for multiple instances of TGMPA.
        ...
        'strings' => [
            'page_title' => sprintf(__('Install Recomenned %s Plugins', REBOOT_CORE_TEXT_DOMAIN), REBOOT_AGENCY),
            'menu_title' => __('Install Plugins', REBOOT_CORE_TEXT_DOMAIN),
        ]

        /*
        'strings'      => array(
            'page_title'                      => __( 'Install Required Plugins', REBOOT_CORE_TEXT_DOMAIN ),
            'menu_title'                      => __( 'Install Plugins', REBOOT_CORE_TEXT_DOMAIN ),
            /* translators: %s: plugin name. * /
            'installing'                      => __( 'Installing Plugin: %s', REBOOT_CORE_TEXT_DOMAIN ),
            /* translators: %s: plugin name. * /
            'updating'                        => __( 'Updating Plugin: %s', REBOOT_CORE_TEXT_DOMAIN ),
            'oops'                            => __( 'Something went wrong with the plugin API.', REBOOT_CORE_TEXT_DOMAIN ),
            'notice_can_install_required'     => _n_noop(
                /* translators: 1: plugin name(s). * /
                'This theme requires the following plugin: %1$s.',
                'This theme requires the following plugins: %1$s.',
                REBOOT_CORE_TEXT_DOMAIN
            ),
            ...
            'return'                          => __( 'Return to Required Plugins Installer', REBOOT_CORE_TEXT_DOMAIN ),
            'plugin_activated'                => __( 'Plugin activated successfully.', REBOOT_CORE_TEXT_DOMAIN ),
            'activated_successfully'          => __( 'The following plugin was activated successfully:', REBOOT_CORE_TEXT_DOMAIN ),
            /* translators: 1: plugin name. * /
            'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', REBOOT_CORE_TEXT_DOMAIN ),
            /* translators: 1: plugin name. * /
            'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', REBOOT_CORE_TEXT_DOMAIN ),
            /* translators: 1: dashboard link. * /
            'complete'                        => __( 'All plugins installed and activated successfully. %1$s', REBOOT_CORE_TEXT_DOMAIN ),
            'dismiss'                         => __( 'Dismiss this notice', REBOOT_CORE_TEXT_DOMAIN ),
            'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', REBOOT_CORE_TEXT_DOMAIN ),
            'contact_admin'                   => __( 'Please contact the administrator of this site for help.', REBOOT_CORE_TEXT_DOMAIN ),
