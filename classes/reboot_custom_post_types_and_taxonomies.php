                ...
                'block' => [
                    ...
                    'args' => [
                        ...
                        'labels' => self::get_post_type_labels(
                            __('Block', REBOOT_TEXT_DOMAIN),
                            __('Blocks', REBOOT_TEXT_DOMAIN)
                        ),
                    ]
                ],
...
//                ],
        ...
        public static function get_post_type_labels($singular, $plural)
        {
            return [
                ...
                // 'add_new' => __('Add New', REBOOT_TEXT_DOMAIN),
                'add_new_item' => sprintf(__('Add New %s', REBOOT_TEXT_DOMAIN), $singular),
                'edit_item' => sprintf(__('Edit %s', REBOOT_TEXT_DOMAIN), $singular),
                'new_item' => sprintf(__('Add New %s', REBOOT_TEXT_DOMAIN), $singular),
                'view_item' => sprintf(__('View %s', REBOOT_TEXT_DOMAIN), $singular),
                'view_items' => sprintf(__('View %s', REBOOT_TEXT_DOMAIN), $plural),
                'search_items' => sprintf(__('Search %s', REBOOT_TEXT_DOMAIN), $singular),
                'not_found' => sprintf(__('No %s found', REBOOT_TEXT_DOMAIN), $plural),
                'not_found_in_trash' => sprintf(__('No %s found in Trash', REBOOT_TEXT_DOMAIN), $plural),
                'parent_item_colon' => sprintf(__('Parent %s:', REBOOT_TEXT_DOMAIN), $singular),

                // 'all_items' => sprintf(__('All %s', REBOOT_TEXT_DOMAIN), $plural),
                'all_items' => $plural,

                'archives' => sprintf(__('%s Archives', REBOOT_TEXT_DOMAIN), $singular),
                'attributes' => sprintf(__('%s Attributes', REBOOT_TEXT_DOMAIN), $singular),
                'insert_into_item' => sprintf(__('Insert into %s', REBOOT_TEXT_DOMAIN), $singular),
                'uploaded_to_this_item' => sprintf(__('Uploaded to this %s', REBOOT_TEXT_DOMAIN), $singular),
                // 'featured_image' => __('Featured Image', REBOOT_TEXT_DOMAIN),
                // 'set_featured_image' => __('Set featured image', REBOOT_TEXT_DOMAIN),
                // 'remove_featured_image' => __('Remove featured image', REBOOT_TEXT_DOMAIN),
                // 'use_featured_image' => __('Use as featured image', REBOOT_TEXT_DOMAIN),
                // 'menu_name' => $plural,
                'filter_items_list' => sprintf(__('Filter %s list', REBOOT_TEXT_DOMAIN), $plural),
                'items_list_navigation' => sprintf(__('%s list navigation', REBOOT_TEXT_DOMAIN), $singular),
                'items_list' => sprintf(__('%s list', REBOOT_TEXT_DOMAIN), $singular),
                // 'name_admin_bar' => $singular,
                'item_published' => sprintf(__('%s published.', REBOOT_TEXT_DOMAIN), $singular),
                'item_published_privately' => sprintf(__('%s published privately.', REBOOT_TEXT_DOMAIN), $singular),
                'item_reverted_to_draft' => sprintf(__('%s reverted to draft.', REBOOT_TEXT_DOMAIN), $singular),
                'item_scheduled' => sprintf(__('%s scheduled.', REBOOT_TEXT_DOMAIN), $singular),
                'item_updated' => sprintf(__('%s updated.', REBOOT_TEXT_DOMAIN), $singular),
            ];
        }
        ...
        public static function get_taxonomy_labels($singular, $plural)
        {
            return [
                ...
                'edit_item' => sprintf(__('Edit %s', REBOOT_TEXT_DOMAIN), $singular),
                'view_item' => sprintf(__('View %s', REBOOT_TEXT_DOMAIN), $singular),
                'update_item' => sprintf(__('Update %s', REBOOT_TEXT_DOMAIN), $singular),
                'add_new_item' => sprintf(__('Add New %s', REBOOT_TEXT_DOMAIN), $singular),
                'new_item_name' => sprintf(__('New %s Name', REBOOT_TEXT_DOMAIN), $singular),
                'parent_item' => sprintf(__('Parent %s', REBOOT_TEXT_DOMAIN), $singular),
                'parent_item_colon' => sprintf(__('Parent %s:', REBOOT_TEXT_DOMAIN), $singular),
                'search_items' => sprintf(__('Search %s', REBOOT_TEXT_DOMAIN), $plural),
                'popular_items' => sprintf(__('Popular %s', REBOOT_TEXT_DOMAIN), $plural),
                'separate_items_with_commas' => sprintf(__('Separate %s with commas', REBOOT_TEXT_DOMAIN), $plural),
                'add_or_remove_items' => sprintf(__('Add or remove %s', REBOOT_TEXT_DOMAIN), $singular),
                'choose_from_most_used' => sprintf(__('Choose from the most used %s', REBOOT_TEXT_DOMAIN), $singular),
                'not_found' => sprintf(__('No %s found.', REBOOT_TEXT_DOMAIN), $plural),
                'back_to_items' => sprintf(__('← Back to %s', REBOOT_TEXT_DOMAIN), $plural),
            ];
        }
